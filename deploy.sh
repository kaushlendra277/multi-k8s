...
docker build -t kaushlendra277/multi-client:latest  -f ./client/Dockerfile ./client
docker build -t kaushlendra277/multi-server:latest  -f ./server/Dockerfile ./server
docker build -t kaushlendra277/multi-worker:latest  -f ./worker/Dockerfile ./worker
